...
public class AppContext {
    ...
    public AppContext() {
        ...
        admin = new Admin(SystemConfig.ADMIN_USERNAME, SystemConfig.ADMIN_PASSWORD, pool, registry, history, auditLog,
                userMap);
    ...
    void seedDummyData() {
        ...
        Object[][] sd = {
                { "Panti Asuhan Al-Ikhlas", "Hj. Fatimah", "panti_alikhlas", "alikhlas123",
                        "081234568001", "Jl. Kenjeran No. 25, Surabaya", -7.2440, 112.7730, 80,
                        ShelterType.ANAK_YATIM },
                { "Panti Lansia Sejahtera", "Bambang Susilo", "panti_lansia", "lansia123",
                        "081234568002", "Jl. Mayjen Sungkono No. 10, Surabaya", -7.2920, 112.7220, 50,
                        ShelterType.LANSIA },
                { "Rumah Singgah Harapan", "Dewi Kurniasih", "panti_harapan", "harapan123",
                        "081234568003", "Jl. Kertajaya No. 56, Surabaya", -7.2750, 112.7630, 40,
                        ShelterType.ANAK_YATIM },
                ...
                { "Panti Asuhan Baitussalam", "Ustadz Zainal", "panti_baitussalam", "baitussalam123",
                        "081234568005", "Jl. Wonokromo No. 18, Surabaya", -7.3010, 112.7350, 65,
                        ShelterType.ANAK_YATIM }
        };
